...
public class ArchivoLeerTexto {
     ...
     *
     * @param filename es un tipo String y contiene el nombre del archivo a leer
     * @param delimitador un tipo String, y contiene el caractér por el cuál se
     * desea partir cada línea del archivo
     */
    ...
    /**
     * Método que convierte el archivo de texto plano a una matriz, donde cada
     * línea es una fila de la matriz y cada columna es el campo que esta
     * representado por el delimitador del archivo. Esté método debe ser usado
     * con el constructor que recibe dos paramétros
     *
